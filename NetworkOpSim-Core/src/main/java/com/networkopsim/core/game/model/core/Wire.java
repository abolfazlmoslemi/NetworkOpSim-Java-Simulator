// FILE: /NetworkOpSim-Multiplayer/NetworkOpSim-Core/src/main/java/com/networkopsim/core/game/model/core/Wire.java
// ================================================================================
...
public class Wire implements Serializable {
    ...
    public Wire(Port startPort, Port endPort, int ownerId) {
    ...
    public Wire(Port startPort, Port endPort) {
        this(startPort, endPort, 0); // Default to neutral owner
    }
    ...
    public void moveRelayPoint(int index, Point2D.Double newPosition) {
        if (index >= 0 && index < relayPoints.size()) {
            relayPoints.get(index).setPosition(newPosition);
            recalculateLength();
        }
    }
    ...
    public int getBulkPacketTraversals() { return bulkPacketTraversals; }
