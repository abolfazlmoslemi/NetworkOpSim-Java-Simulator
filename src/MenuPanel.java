...
public class MenuPanel extends JPanel {
    ...
    private void loadBackgroundImage() {
        try {
            File imgFile = new File("assets/images/menu_background.png");
            if (imgFile.exists() && imgFile.isFile()) {
                backgroundImage = new ImageIcon(imgFile.getAbsolutePath()).getImage();
                java.lang.System.out.println("Menu background loaded: " + imgFile.getAbsolutePath());
            } else {
                java.lang.System.err.println("Warning: Menu background image not found at " + imgFile.getAbsolutePath());
                JOptionPane.showMessageDialog(this.game, 
                        "Menu background image (menu_background.png) not found.\nExpected: " + imgFile.getAbsolutePath(),
                        "Asset Warning", JOptionPane.WARNING_MESSAGE);
                backgroundImage = null;
            }
        } catch (Exception e) {
            java.lang.System.err.println("Error loading menu background image: " + e.getMessage());
            e.printStackTrace();
            backgroundImage = null;
            JOptionPane.showMessageDialog(this.game,
