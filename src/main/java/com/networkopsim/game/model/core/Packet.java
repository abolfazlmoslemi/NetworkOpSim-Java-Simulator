// ===== File: Packet.java (FINAL - Added isVolumetric() helper method) =====
...
public class Packet implements Serializable {
    ...
    public void reverseDirection(GameEngine gameEngine) {
        ...
        if (!gameEngine.getGame().isMuted()) gameEngine.getGame().playSoundEffect("packet_reverse");
    }
    ...
    // [NEW] Helper method to identify volumetric packets (BULK or WOBBLE).
