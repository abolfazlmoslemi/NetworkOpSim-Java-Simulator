// ===== File: LevelSelectionPanel.java (UNCHANGED - Logic remains the same) =====
// ===== MODULE: client =====
...
public class LevelSelectionPanel extends JPanel {
  ...
  private void styleStandardButton(JButton button, Color bgColor, Color borderColor) {
    ...
    button.addMouseListener(new MouseAdapter() {
      ...
      @Override
      public void mouseExited(MouseEvent e) { if (button.isEnabled()) button.setBackground(originalColor); }
    });
  }
